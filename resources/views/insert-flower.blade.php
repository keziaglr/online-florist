...
@section('content')
<form action="{{ url('flower/insert') }}" style="margin: 50px 100px" method="POST" enctype="multipart/form-data">
    {{csrf_field()}}
    <h2> <strong class="d-flex justify-content-center">Insert Flower</strong> </h2>
    @if ($errors->any())
    ...
    <div class="form-group">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control" id="flower_name" placeholder="Flower Name" name="flower_name" value="{{old('flower_name')}}">
            <label for="floatingInput">Flower Name</label>
        </div>
        <label class="form-label mt-4" >Flower Price</label>
        <div class="form-floating mb-3">
            <input type="number" class="form-control" id="flower_price" placeholder="Flower Price" name="flower_price" value="{{old('flower_price')}}">
            <label for="floatingInput">Flower Price</label>
        </div>
        <label class="form-label mt-4" >Flower Stock</label>
        <div class="form-floating mb-3">
            <input type="number" class="form-control" id="flower_stock" placeholder="Flower Stock" name="flower_stock" value="{{old('flower_stock')}}">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="exampleTextarea" rows="4" name="flower_desc">{{old('flower_desc')}}</textarea>
          </div>
        </div>
        <div class="form-group">
