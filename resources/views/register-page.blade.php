...
@section('content')
<form action="{{ url('user/register') }}" style="margin: 50px 100px" method="POST" enctype="multipart/form-data">
    {{csrf_field()}}
    <h2> <strong class="d-flex justify-content-center" >Register</strong> </h2>
    @if ($errors->any())
    ...
    <div class="form-group">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control" name="phone" id="floatingInput" placeholder="Phone Number" value="{{old('phone')}}">
        ...
        <label class="form-label mt-4" >Confirm Password</label>
            <div class="form-floating">
              <input type="password" class="form-control" name="cfpassword" id="cfpassword" placeholder="Password" value="{{old('cfpassword')}}">
